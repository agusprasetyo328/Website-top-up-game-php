<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
  <div class="container">
    <a href="index.php" class="navbar-brand" style=@import url(https://fonts.cdnfonts.com/css/h-herein);>infinityshop</a>
      ...
      <ul class="nav navbar-nav">
       <li class="nav-item dropdown">
         ...
         <div class="dropdown-menu">
           <a href="products.php#mobilelegends" class="dropdown-item">Mobile Legends</a>
           <a href="products.php#pubgmobile" class="dropdown-item">PUBG Mobile</a>
           <a href="products.php#freefire" class="dropdown-item">Free Fire</a>
           <a href="products.php#arenaofvalor" class="dropdown-item">Arena of Valor</a>
         </div>
       </li>
       <li class="nav-item"><a href="tracepurcase.php" class="nav-link">Lacak Pembelian</a></li>
       <li class="nav-item"><a href="contact.php" class="nav-link">Hubungi Admin</a></li>
       <?php
...
<div class="modal fade" id="login" >
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content"style="background-color:rgba(255,255,255,0.95)">
      ...
      <a href="#card.php">forgot password ?</a>
    </div>
